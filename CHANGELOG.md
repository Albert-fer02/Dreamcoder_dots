...
- Refined Ember Noir dark tokens so diagnostic blue meets the dark APCA body floor while preserving foreground hue distinction in Neovim syntax groups.
- Rebalanced dark muted, subtle, and comment roles into a clearer hierarchy for long-session editor readability.

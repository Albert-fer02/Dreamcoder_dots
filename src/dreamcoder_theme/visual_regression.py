...
TARGETS = [
    (
        "neovim",
        "Neovim editor",
        "DreamcoderThemes/dreamcoder/nvim-dreamcoder.lua",
        "manual: open sample buffers and capture Neovim window",
    ),
    (
        "kitty",
        "Kitty terminal",
        "DreamcoderKitty/.config/kitty/colors-dreamcoder.conf",
        "manual: open themed Kitty and capture terminal window",
    ),
    (
        "ghostty",
        "Ghostty terminal",
        "DreamcoderGhostty/.config/ghostty/themes/dreamcoder",
        "manual: open themed Ghostty and capture terminal window",
    ),
    (
        "waybar",
        "Waybar desktop bar",
        "DreamcoderThemes/dreamcoder/waybar-light.css",
        "manual: capture top bar after applying mode",
    ),
    (
        "rofi",
        "Rofi launcher",
        "DreamcoderThemes/dreamcoder/rofi-light.rasi",
        "manual: open Rofi theme preview and capture launcher",
    ),
    (
        "codex-cli",
        "Codex CLI theme",
        "DreamcoderCodexCLI/Dreamcoder.tmTheme",
    ...
    (
        "bat",
        "bat syntax viewer",
        "DreamcoderBat/.config/bat/themes/Dreamcoder-Light.tmTheme",
        "manual: run bat against shell/python/markdown samples",
    ),
    (
        "delta",
        "delta git diff",
        "DreamcoderThemes/dreamcoder/delta-dreamcoder-light.gitconfig",
        "manual: preview git diff with additions/deletions",
    ),
    (
        "fzf",
        "fzf picker",
        "DreamcoderThemes/dreamcoder/fzf-dreamcoder-light.sh",
        "manual: open fzf with preview window",
    ),
    (
        "btop",
        "btop monitor",
        "DreamcoderThemes/dreamcoder/btop-dreamcoder-light.theme",
        "manual: open btop and capture process + graph panels",
    ),
    (
        "dunst",
        "Dunst notifications",
        "DreamcoderThemes/dreamcoder/dunst-dreamcoder-light.conf",
        "manual: trigger low/normal/critical notifications",
    ),
    (
        "cava",
        "Cava visualizer",
        "DreamcoderThemes/dreamcoder/cava-dreamcoder-light.config",
        "manual: capture Cava bars on light terminal",
    ),
    (
        "obsidian",
        "Obsidian notes",
        "DreamcoderThemes/dreamcoder/obsidian-dreamcoder-light.css",
        "manual: capture note, code block, and callout",
    ),
    (
        "firefox",
        "Firefox chrome",
        "DreamcoderThemes/dreamcoder/firefox-dreamcoder-light.css",
